...
void nsga2_optimization::mutation_pop (  population *pop)
{
    int i;
...
void nsga2_optimization::mutation_ind (  individual *ind)
{
...
void nsga2_optimization::bin_mutate_ind (  individual *ind)
{
    int j, k;
    double prob;
...
void nsga2_optimization::real_mutate_ind ( individual *ind)
{
    int j;
