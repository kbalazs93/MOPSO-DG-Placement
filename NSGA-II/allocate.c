...
void nsga2_optimization::allocate_memory_pop ( population *pop, int size)
{
    int i;
...
void nsga2_optimization::allocate_memory_ind ( individual *ind)
{
    int j;
...
void nsga2_optimization::deallocate_memory_pop ( population *pop, int size)
{
    int i;
    for (i=0; i<size; i++)
    {
...
void nsga2_optimization::deallocate_memory_ind ( individual *ind)
{
    int j;
    if (nsga2Params.nreal != 0)
    {
