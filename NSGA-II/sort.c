...
void nsga2_optimization::quicksort_front_obj(population *pop, int objcount, int obj_array[], int obj_array_size)
{
...
void nsga2_optimization::q_sort_front_obj(population *pop, int objcount, int obj_array[], int left, int right)
{
    int index;
    int temp;
    int i, j;
...
void nsga2_optimization::quicksort_dist(population *pop, int *dist, int front_size)
{
...
void nsga2_optimization::q_sort_dist(population *pop, int *dist, int left, int right)
{
    int index;
    int temp;
    int i, j;
