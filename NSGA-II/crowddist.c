...
void nsga2_optimization::assign_crowding_distance_list ( population *pop, list *lst, int front_size)
{
    int **obj_array;
    int *dist;
    int i, j;
...
void nsga2_optimization::assign_crowding_distance_indices ( population *pop, int c1, int c2)
{
    int **obj_array;
    int *dist;
    int i, j;
...
void nsga2_optimization::assign_crowding_distance ( population *pop, int *dist, int **obj_array, int front_size)
{
    int i, j;
    for (i=0; i<nsga2Params.nobj; i++)
    {
